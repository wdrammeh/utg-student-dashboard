...
public class About extends KDialog {
    ...
    public About() {
        ...
        midCard.addLayoutComponent(midLayer.add(getFeedbackCard()), "feedback");
    ...
    private KPanel getAboutCard() {
        ...
        bottomLayer.addAll(new KLabel("Release: " + Dashboard.VERSION, FontFactory.createPlainFont(15)),
                ...
                new KLabel("Contact: +220 327 9265", FontFactory.createPlainFont(15)));
    ...
    private KScrollPane getFeedbackCard() {
        ...
        // return feedbackCard;
        final KScrollPane feedbackLayout = new KScrollPane(feedbackCard, new Dimension(680, 500));
        SwingUtilities.invokeLater(feedbackLayout::toTop);
    ...
    private static class AuthorDialog extends KDialog {
        ...
        private AuthorDialog() {
            ...
            pobPanel.add(new KPanel(new KLabel("Diabugu", valueFont)),
                    BorderLayout.CENTER);
            ...
            telephonePanel.add(new KPanel(new KLabel("+220 341 3910", valueFont)), BorderLayout.CENTER);
